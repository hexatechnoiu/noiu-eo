    ...
    <div class="max-w-screen-xl text-center py-8 px-4 mx-auto lg:py-16 lg:px-6">
        ...
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="max-w-xs text-sm text-center text-neutral-60 bg-white border border-neutral-20 rounded-xl shadow-lg mx-auto mb-5 p-14 hover:scale-110 transition-transform duration-[400ms]">
                ...
                <div class="flex flex-row gap-3 justify-center mt-3">
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://wa.me/085158266733/" target="blank"><i class="fa-brands fa-whatsapp fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://instagram.com/en0kich4n/" target="blank"><i class="fa-brands fa-instagram fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://github.com/en0kich4n/" target="blank"><i class="fa-brands fa-github fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://www.linkedin.com/in/xylviet/" target="blank"><i class="fa-brands fa-linkedin-in fa-lg text-center"></i></a>
                    </div>
                </div>
            </div>
            <div class="max-w-xs text-center text-sm text-neutral-60 bg-white border border-neutral-20 rounded-xl shadow-lg mx-auto p-14 hover:scale-110 transition-transform duration-[400ms]">
                ...
                <div class="flex flex-row gap-3 justify-center mt-3">
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://wa.me/qr/AC44YKCYABNLM1/" target="blank"><i class="fa-brands fa-whatsapp fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://www.instagram.com/ristinnandnnii_/" target="blank"><i class="fa-brands fa-instagram fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://github.com/RistinAndini78/" target="blank"><i class="fa-brands fa-github fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://www.linkedin.com/in/ristin-iman-andini-896a44287/" target="blank"><i class="fa-brands fa-linkedin-in fa-lg text-center"></i></a>
                    </div>
                </div>
            </div>
            <div class="max-w-xs text-sm text-center text-neutral-60 bg-white border border-neutral-20 rounded-xl shadow-lg mx-auto p-14 hover:scale-110 transition-transform duration-[400ms]">
                ...
                <div class="flex flex-row gap-3 justify-center mt-3">
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://wa.me/085927778314/" target="blank"><i class="fa-brands fa-whatsapp fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://instagram.com/dllaa.te/" target="blank"><i class="fa-brands fa-instagram fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://github.com/dellafan/" target="blank"><i class="fa-brands fa-github fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://www.linkedin.com/in/della-friska-ardiana-1bb587290/" target="blank"><i class="fa-brands fa-linkedin-in fa-lg text-center"></i></a>
                    </div>
                </div>
            </div>
            <div class="max-w-xs text-sm text-center text-neutral-60 bg-white border border-neutral-20 rounded-xl shadow-lg mx-auto p-14 hover:scale-110 transition-transform duration-[400ms]">
                ...
                <div class="flex flex-row gap-3 justify-center mt-3">
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://wa.me/081902776222/" target="blank"><i class="fa-brands fa-whatsapp fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://instagram.com/stnrainimrym_/" target="blank"><i class="fa-brands fa-instagram fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://github.com/SitiNurainiMaryam6/" target="blank"><i class="fa-brands fa-github fa-lg text-center"></i></a>
                    </div>
                    <div class="flex justify-center items-center w-8 h-8 text-lg text-primary-40 hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <a href="https://www.linkedin.com/in/siti-nuraini-maryam-81225a290/" target="blank"><i class="fa-brands fa-linkedin-in fa-lg text-center"></i></a>
                    </div>
                </div>
            </div>
        </div>
