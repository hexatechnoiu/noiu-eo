                        ...
                        <tbody>
                            @forelse ($package_type as $pkg_type)
                                @foreach ($pkg_type->packages as $pkg)
                                    <tr class="border-b">
                                        <td class="px-4 py-3"><img src="{{ asset('/storage/' . $pkg->picture) }}"></td>
                ...
                <form action="/dashboard/packages" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="desc" class="block mb-2 text-sm font-medium text-black">desc</label>
                ...
                <form enctype="multipart/form-data" id="update_modal" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="file" id="update_picture" name="Picture"
                                class="form-control @error('picture') is-invalid @enderror bg-neutral-10 border border-neutral-30 text-black text-sm rounded-lg focus:ring-primary-20 focus:border-primary-40 block w-full cursor-pointer"
                                >
                            @error('picture')
                                <div class="invalid-feedback">
        ...
        <div class="relative p-4 w-full max-w-5xl max-h-full">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
                ...
                <div class="flex flex-row gap-4">
                    ...
                    <div>
                        <h3 class="mb-6 text-2xl text-black font-semibold" id="pre-name">Paket Outbound 2 Hari 1 Malam</h3>
                        <dt class="mt-2 font-semibold leading-none text-black">Category</dt>
                        <dd class="mb-4 font-light text-base text-neutral-60 sm:mb-5" id="pre-category">Outbound</dd>
                        </dl>
                        <dt class="mt-2 font-semibold leading-none text-black">Price</dt>
                        <dd class="mb-4 font-light text-base text-neutral-60 sm:mb-5">Rp. <span id="pre-price"></span> /Orang</dd>
                        </dl>
                        <dl>
                            <dt class="mt-2 font-semibold leading-none text-black">desc</dt>
                            <dd class="mb-4 font-light text-neutral-60 sm:mb-5" id="pre-desc">Program Fun Games / Competition Games,
                                Hotel 1 Malam, High Rope ( Flying Fox - 2 Line Bridge - Turun Tebing ) Makan 3X, Coffie
                                Break, Acara Hiburan by MC + Solo Organ, Peserta Min 20 Pax</dd>
                    </div>
                    <div>
                        <button type="button"
        ...
        <div class="relative p-4 w-full max-w-xl max-h-full">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
                ...
                <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                    <img class="mb-4 h-36" src="{{ asset('img/outbound2.jpg') }}" alt="Picture">
                    <div>
                ...
                <div>
                    ...
                    <dl><dt class="mt-2 font-semibold leading-none text-black">desc</dt><dd class="mb-4 font-light text-neutral-60 sm:mb-5">Program Fun Games / Competition Games, Hotel 1 Malam, High Rope ( Flying Fox - 2 Line Bridge - Turun Tebing ) Makan 3X, Coffie Break, Acara Hiburan by MC + Solo Organ, Peserta Min 20 Pax</dd>
                </div>
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3 sm:space-x-4">
