<footer class="bg-primary-40">
  <div id="FAQModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="FAQModal">
              ...
              <div class="mb-6">
                  ...
                  <ol class="list-decimal pl-4 space-y-2">
                      <li>
                          ...
                          <p>NOIU Tour & Travel adalah perusahaan tour & travel yang berlisensi resmi, berlokasi di Bandung, yang menyediakan layanan perjalanan wisata, kegiatan Meeting, Gathering, Outbound, dan Minat Khusus.</p>
                      </li>
              ...
              <div class="mb-6">
                  ...
                  <ol class="list-decimal pl-4 space-y-2">
                      <li>
                          ...
                          <p>Kami menawarkan berbagai destinasi wisata domestik dan mancanegara. Untuk informasi lebih lanjut, silakan hubungi kami untuk konsultasi personal.</p>
                      </li>
                      <!-- Tambahkan pertanyaan dan jawaban lainnya di sini -->
                  </ol>
              </div>
              ...
              <div class="mb-6">
                  ...
                  <ol class="list-decimal pl-4 space-y-2">
                      <li>
                          ...
                          <p>Paket-paket ini mencakup berbagai aktivitas seru di daerah Sumedang/Bandung. Untuk detail aktivitas dan harga, silakan hubungi kami.</p>
                      </li>
                      <!-- Tambahkan pertanyaan dan jawaban lainnya di sini -->
                  </ol>
              </div>
            ...
            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button data-modal-hide="FAQModal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Tutup</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="flex flex-col sm:flex-row lg:w-[600px] gap-10 lg:ml-10 max-w-screen-xl">
                <div>
                    ...
                    <ul class="text-white font-light">
                        <li class="mb-4">
                            <a href="/home" class="hover:text-secondary-40 duration-[400ms]">Home</a>
                        </li>
                        <li class="mb-4">
                            <a href="/outbound" class="hover:text-secondary-40 duration-[400ms]">Outbound Package</a>
                        </li>
                        <li class="mb-4">
                            <a href="/mice" class="hover:text-secondary-40 duration-[400ms]">Event Organizer</a>
                        </li>
                        <li class="mb-4">
                            <a href="/booking" class="hover:text-secondary-40 duration-[400ms]">Booking</a>
                        </li>
                        <li class="mb-4">
                            <a href="/contact" class="hover:text-secondary-40 duration-[400ms]">Contact Us</a>
                        </li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap text-white font-light">
                        <span class="mb-4 hover:text-secondary-40 duration-[400ms]"><i class="fa-solid fa-phone mr-2"></i>+62-857-7180-5236</span>
                        <span class="mb-4 hover:text-secondary-40 duration-[400ms]"><i class="fa-solid fa-envelope mr-2"></i>hexatechnoiu@gmail.com</span>
                        <span class="mb-4 hover:text-secondary-40 duration-[400ms]"><i class="fa-solid fa-map-location-dot mr-2"></i>Jl. Bukit Nuur No.C36, Cinunuk, Kec. Cileunyi, Kabupaten Bandung, Jawa Barat 40624</span>
                    </div>
                </div>
            </div>
        </div>
