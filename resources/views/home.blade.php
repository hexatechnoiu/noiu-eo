...
<section class="bg-center bg-no-repeat bg-cover bg-Neutral-40 bg-blend-multiply lg:h-[100vh]" style="background-image: url('{{ asset('img/noiu.jpg') }}')">
    <div class="px-4 mx-auto max-w-screen-xl text-center py-44 lg:py-56">
        ...
        <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Between your business objectives and what your customers want.</p>
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="/outbound" class="inline-flex justify-center items-center py-3 px-7 text-lg font-normal text-center text-white rounded-lg bg-primary-40 hover:text-black hover:bg-secondary-40 focus:ring-4 focus:ring-secondary-20 duration-[400ms]">
                Get started
            </a>
        </div>
    </div>
