...
<section id="outbound" class="bg-center bg-no-repeat bg-white bg-blend-multiply pt-20 pb-5">
    ...
    <div class="flex flex-wrap justify-start lg:mx-0">
        <div class="max-w-xs bg-white border border-neutral-20 rounded-lg shadow mx-auto md:mx-0 mb-5 md:ml-9">
            <a href="#">
                <img class="rounded-t-lg w-[318px] h-[229px]" src="<?php echo e($pkg->picture); ?>" alt="" />
            </a>
            <div class="p-5">
                <a href="#">
                    <h1 class="mb-2 text-xl font-bold tracking-tight text-black"><?php echo e($pkg->name); ?></h1>
                </a>
                <p class="mb-2 text-lg font-semibold tracking-tight text-primary-40">Rp. <?php echo e($pkg->price); ?><span
                        class="text-sm font-medium text-neutral-60"> /<?php echo e($pkg->unit); ?></span></p>
                <a href="#"
        ...
        <div class="max-w-xs bg-white border border-neutral-20 rounded-lg shadow mx-auto md:mx-0 mb-5 md:ml-9">
            <a href="#">
                <img class="rounded-t-lg w-[318px] h-[229px]" src="<?php echo e(asset('img/outbound2.jpg')); ?>"
                    alt="" />
            </a>
            <div class="p-5">
                <a href="#">
        ...
        <div class="max-w-xs bg-white border border-neutral-20 rounded-lg shadow mx-auto md:mx-0 mb-5 md:ml-9">
            <a href="#">
                <img class="rounded-t-lg w-[318px] h-[229px]" src="<?php echo e(asset('img/outbound3.jpg')); ?>"
                    alt="" />
            </a>
            <div class="p-5">
                <a href="#">
        ...
        <div class="max-w-xs bg-white border border-neutral-20 rounded-lg shadow mx-auto md:mx-0 mb-5 md:ml-9">
            <a href="#">
                <img class="rounded-t-lg w-[318px] h-[229px]" src="<?php echo e(asset('img/outbound4.jpg')); ?>"
                    alt="" />
            </a>
            <div class="p-5">
                <a href="#">
