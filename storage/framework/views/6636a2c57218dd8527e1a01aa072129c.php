...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 h-screen transition-transform -translate-x-full lg:translate-x-0" aria-label="Sidenav">
    <div class="overflow-y-auto py-5 px-3 h-full bg-primary-20">
        <ul class="space-y-2">
            ...
            <li>
                <?php if($active === 'package'): ?>
                    <button type="button" id="dropdown-button-outbound"
                        class="<?php echo e($active === 'package' ? 'bg-secondary-40 text-black group' : 'text-white'); ?> flex items-center p-2 w-full text-base font-normal rounded-lg"
                ...
                <?php else: ?>
                    <div
                        class="<?php echo e($active === 'package' ? 'bg-secondary-40 text-black group' : 'text-white'); ?> flex items-center p-2 w-full text-base font-normal rounded-lg transition cursor-pointer hover:bg-secondary-40 hover:text-black duration-[400ms]">
                        <a href="/package">
                            <i class="fa-solid fa-person-hiking fa-lg"></i>
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Outbound Package</span>
                        </a>
...
<?php /**PATH /home/azfasa15/laravel_noiu/resources/views/partials/sidebar.blade.php ENDPATH**/ ?>